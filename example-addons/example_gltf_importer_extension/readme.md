...
gather_import_light_after_hook(self, gltf_node, gltf_light, blender_light, import_settings)
...
gather_import_camera_after_hook(self, gltf_node, gltf_camera, blender_camera, import_settings)
