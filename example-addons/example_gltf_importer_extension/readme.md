...
gather_import_animations(self, gltf_animations, animation_options, import_settings)
gather_import_animation_before_hook(self, gltf, anim_idx, import_settings)
gather_import_animation_after_hook(self, gltf, anim_idx, track_name, import_settings)
