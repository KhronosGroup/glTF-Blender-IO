...
def __gather_animations(blender_scene, export_settings):
    ...
    if export_settings['gltf_nla_strips'] != "MONOCHAR":
        ...
        _blender_object = [obj for obj in blender_scene.objects if obj.type == "ARMATURE"][0]
        blender_object = _blender_object #TODO PROXY
    ...
    if export_settings['gltf_nla_strips'] == "OFF":
