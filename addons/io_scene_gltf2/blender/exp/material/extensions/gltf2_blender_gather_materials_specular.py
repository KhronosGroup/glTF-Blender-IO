...
def export_original_specular(blender_material, export_settings):
    ...
    if specular_non_linked is True:
        ...
        if gltf2_blender_get.has_image_node_from_socket(original_specular_socket):
            original_specular_texture, original_specular_use_active_uvmap, uvmap_attribute_name_original_specular, _ = gather_texture_info(
    ...
    if specularcolor_non_linked is True:
        ...
        if gltf2_blender_get.has_image_node_from_socket(original_specularcolor_socket):
            original_specularcolor_texture, original_specularcolor_use_active_uvmap, uvmap_attribute_name_specular, _ = gather_texture_info(
...
def export_specular(blender_material, export_settings):
    ...
    if no_texture:
        ...
        specularColorTexture, use_active_uvmap, uvmap_attribute_name_specular, specularColorFactor = gather_texture_info(
            primary_socket,
            sockets,
            (),
            export_settings,
