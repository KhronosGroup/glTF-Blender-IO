...
def export_clearcoat(bmat, export_settings):
    ...
    clearcoat_socket = bmat.get_socket('Coat Weight')
    clearcoat_roughness_socket = bmat.get_socket('Coat Roughness')
    clearcoat_normal_socket = bmat.get_socket('Coat Normal')
