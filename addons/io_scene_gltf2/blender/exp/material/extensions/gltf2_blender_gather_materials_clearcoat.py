...
def export_clearcoat(blender_material, export_settings):
    ...
    clearcoat_socket = gltf2_blender_get.get_socket(blender_material.node_tree, blender_material.use_nodes, 'Clearcoat')
    clearcoat_roughness_socket = gltf2_blender_get.get_socket(blender_material.node_tree, blender_material.use_nodes, 'Clearcoat Roughness')
    clearcoat_normal_socket = gltf2_blender_get.get_socket(blender_material.node_tree, blender_material.use_nodes, 'Clearcoat Normal')
