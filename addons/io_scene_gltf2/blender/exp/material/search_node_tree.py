...
def detect_iridescence_thickness_texure(socket, minimum_thickness_socket, export_settings):
    ...
    # Check that the mix node factor is linked to a separate RGB node, with R linked to the iridescence thickness texture
    ...
    # Check that the mix node A is linked to a value node, that is itself linked (output) to the iridescence minimum thickness socket of the glTF material output node
